...
export default class LeapYear extends Component {
  ...
  divisibleBy4AndNotBy100 = () => this.divisibleBy4() && !this.divisibleBy100();

  isLeapYear = () => this.divisibleBy400() || (!this.divisibleBy100AndNotBy400() && this.divisibleBy4AndNotBy100());
